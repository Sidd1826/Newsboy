...
<body>
  ...
  <span>
    <div class="bgo">
      ...
      <a href="delete.php"><button class="btn btn-delete" style="float:right; margin-bottom:30px;">
                <span class="mdi mdi-delete mdi-24px"></span>
                <span class="mdi mdi-delete-empty mdi-24px"></span>
                <span>Delete RSS Feed</span>
              </button></a>
      <br /><br />
      ...
      <div>
        ...
        if (isset($_SESSION["Username"])) {
          ...
          for ($x = 0; $x < $b; $x++) {
            ...
            if (empty($rss)) {
              $h = $rowl["Summary"];
              $i = "rss/index.php?url=$h";
        ?>
              <a href="<?php echo $i; ?>"><button class="accordion" style="background-color:#1b1f24; color:white;"><?php echo $d; ?></button></a>

            <?php } else {
            ?>
              <button class="accordion" style="background-color:#1b1f24; color:white;"><?php echo $d; ?></button>
            <?php
            }
            ?>
            <div class="panel">
              <?php
              #echo $f;
              for ($y = 0; $y < count($rss); $y++) {
                $g = "rss/index.php?url=$rsslinks[$y]";
              ?>
                <a href="<?php echo $g; ?>">
                  <div class="accordion" style="background-color:#1b1f24; color:white;"><?php echo $rss[$y]; ?></div>
                </a>
              <?php  } ?>
            </div>
        <?php
